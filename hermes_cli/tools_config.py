...
CONFIGURABLE_TOOLSETS = [
    ...
    ("dfm",              "DFM Analysis",                 "project intake and manufacturability analysis"),
]
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "dfm"}
