...
exec env -i \
  ...
  ${DFM_GEOMETRY_E2E_EXECUTABLE:+DFM_GEOMETRY_E2E_EXECUTABLE="$DFM_GEOMETRY_E2E_EXECUTABLE"} \
  ${DFM_GEOMETRY_SCHEMA_ROOT:+DFM_GEOMETRY_SCHEMA_ROOT="$DFM_GEOMETRY_SCHEMA_ROOT"} \
